...
description: Review generated Epics/Stories against PRD and architecture artifacts, then produce a gap-and-ambiguity audit report. Use when tickets exist under i2o-project-ai-docs/projects/{project_id}/{release_id}/docs/tickets (or nearby tickets folders) and an AI agent must validate requirement coverage, architectural alignment, sequencing, and clarity before implementation or Jira publishing.
---
